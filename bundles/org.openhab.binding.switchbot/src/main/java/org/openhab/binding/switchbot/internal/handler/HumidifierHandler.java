...
import org.openhab.binding.switchbot.internal.config.HumidifierConfig;
...
/**
 * The {@link HumidifierHandler} is responsible for handling commands, which are
 * sent to one of the channels. It maps the OpenHAB world to the Switchbot world.
 *
 * @author Arjan Lamers - Initial contribution
 */
public class HumidifierHandler extends SwitchbotHandler {

    private Logger logger = LoggerFactory.getLogger(HumidifierHandler.class);

    public HumidifierHandler(Thing thing) {
        super(thing);
    }
